...
ldd r16,y+6             ;round_key[0] = round_key[6]
st	x+,r16
ldd r16,y+7				;round_key[1] = round_key[7]
st  x+,r16
ldd r16,y+8				;round_key[2] = round_key[8] ^ i
eor r16,r19
st  x+,r16 
ldd r16,y+9				;round_key[3] = round_key[9]
st  x+,r16
ldd r16,y+5				;round_key[4] = round_key[5]
st  x,r16
...
ld  r16,x+             ;round_key[5] = temp_state[1] ^ round_key[6]
ldd r17,y+6
eor r16,r17
std y+5,r16

ld  r16,x+			   ;round_key[6] = sbox8[temp_state[2] ^ round_key[7]];
ldd r17,y+7
eor r16,r17
ldi r31,high(sbox<<1)
mov r30,r16
...
ld  r16,x			   ;round_key[7] = sbox8[temp_state[3] ^ round_key[8]];
ldd r17,y+8
eor r16,r17
ldi r31,high(sbox<<1)
mov r30,r16
...
ldd r16,z+4				;round_key[8] = temp_state[4] ^ round_key[9];
ldd r17,y+9
eor r16,r17
std y+8,r16

ldd r16,z+0				;round_key[9] = temp_state[0] ^ temp_state[5];
ldd r17,z+5
eor r16,r17
std y+9,r16
ret
...
ldd r16,y+5     		    ;temp_state[0] = round_key[5]
st   x+,r16
ldd  r16,y+6				;temp_state[1] = round_key[6]
st  x+,r16
ldd  r16,y+7				;temp_state[2] = round_key[7]
st  x+,r16
ldd  r16,y+8				;temp_state[3] = round_key[8]
st  x+,r16
ldd  r16,y+9				;temp_state[4] = round_key[9]
st  x,r16

ldi r29,high(round_key) ;round_key->y
ldi r28,low(round_key)
ldd r16,y+4             ;round_key[5] = round_key[4]
std	y+5,r16
ldd r16,y+0		     	;round_key[6] = round_key[0]
std y+6,r16
ldd r16,y+1		   	    ;round_key[7] = round_key[1]
std y+7,r16
ldd r16,y+2			    ;round_key[8] = round_key[2] ^ (round-i)
ldi r17,$10
sub r17,r19
eor r16,r17
std  y+8,r16 
ldd r16,y+3				;round_key[9] = round_key[3]
std  y+9,r16
...
ldi r29,high(round_key) ;round_key->y
ldi r28,low(round_key)
ld  r16,x+             ;round_key[1] = temp_state[0] ^ round_key[6]
ldd r17,y+6
eor r16,r17
std y+1,r16
ld  r16,x+			   ;round_key[2] = sbox8[temp_state[1] ]^ round_key[7];
ldi r31,high(sbox<<1)
mov r30,r16
lpm r16,z
ldd r17,y+7
eor r16,r17
std y+2,r16
ld  r16,x+			   ;round_key[3] = sbox8[temp_state[2] ]^ round_key[8];
ldi r31,high(sbox<<1)
mov r30,r16
lpm r16,z
ldd r17,y+8
eor r16,r17
std y+3,r16
ld  r16,x+             ;round_key[4] = temp_state[3] ^ round_key[9]
ldd r17,y+9
eor r16,r17
std y+4,r16
ld  r16,x             ;round_key[0] = temp_state[4] ^ round_key[5]
ldd r17,y+5
eor r16,r17
st  y,r16
ret
